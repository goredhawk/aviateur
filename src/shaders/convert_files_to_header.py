...
for current_dir, dir_list, file_list in os.walk(r"./"):
    for file_name in file_list:
        ...
        dst_stream.write("#ifndef AVIATEUR_SHADER_" + base_name.upper() + "_H\n")
        dst_stream.write("#define AVIATEUR_SHADER_" + base_name.upper() + "_H\n\n")

        dst_stream.write("namespace aviateur {\n    static uint8_t " + base_name + "[] = {")
        ...
        dst_stream.write("}\n\n#endif //AVIATEUR_SHADER_" + base_name.upper() + "_H\n")
        dst_stream.close()
